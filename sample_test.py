...
my_bad_role_arn = "arn:aws:iam::123456789012:role/lambda-role:9"
...
my_layer_arn = "arn:aws:lambda:us-east-1:123456789012:layer:my-layer:6"
...
role_arns = [
    "arn:aws:iam::123456789012:role/application-role:3",  # should be flagged
